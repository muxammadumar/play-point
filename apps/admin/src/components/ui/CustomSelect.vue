  ...
  <div ref="selectRef" class="relative">
    <div class="cursor-pointer select-none" @click="toggleDropdown">
      <template v-if="!multiple">
        ...
        <slot v-else name="option" :option="singleValue">
          {{ singleValue?.name }}
        </slot>
      </template>
        ...
        <div v-else class="flex flex-wrap gap-1.5">
          <slot name="selected" :options="selectedValues">
            <div
              ...
              :key="idx"
              class="inline-flex items-center gap-1 bg-blue-100 text-blue-800 px-2 py-0.5 rounded-lg text-xs"
            >
    ...
    <Teleport to="body">
      ...
      >
        ...
        <div
          ...
          class="cursor-pointer rounded-lg transition-colors"
          :class="{ 'hover:bg-gray-50 p-2': !multiple }"
        >
...
const singleValue = computed(() => {
  ...
  return props.modelValue as any | null;
});
...
//     (item: any) => item[props.compareKey] === option[props.compareKey]
//   );
// };
